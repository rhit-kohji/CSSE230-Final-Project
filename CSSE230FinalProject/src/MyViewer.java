...
//	    	    }
	    	    ...
	    	    String[] startingLocationTimeOrDist = {"Start for Dist/Time", "Akh Va'quot", "Bareeda Naag", "Dunba Taag", "Gee Ha'rah", "Goma Asaagh", "Hia Miu","Kah Okeo", "Katah Chuki", "Lanno Kooh", "Maag No'rah", "Maka Rah",
	    				"Mijah Rokee","Mogg Latan", "Monya Toma", "Mozo Shenno", "Noya Neha", "Qaza Toki", "Rin Oyaa","Rok Uwog", "Rona Kachta", "Sha Gemma", "Sha Warvo",
	    				"Shada Naw", "Shae Loya", "Sheem Dagoze", "Tena Ko'sah", "To Quomo","Toh Yahsa", "Voo Lota", "Zalta Wa"};
	    				...
	    				if(component.end && component.start) {
	    					...
	    					if(!all.isEmpty()) {
		    					...
		    					if(component.timeOnlyStr != "None" && component.distOnlyStr == "None" ) {
		    						isTime = false;
		    					}else if(component.timeOnlyStr == "None" && component.distOnlyStr != "None" ) {
		    						isTime = true;
		    					...
		    					System.out.println("I should print here");
		    					component.repaint();
		    				} else {
